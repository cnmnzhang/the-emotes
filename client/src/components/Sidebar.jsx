...
const Sidebar = () => {
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-wrap">
      <div className="flex flex-row">
        ...
        <div
          className={`${isOpen ? 'w-full' : 'w-0'
            } transition-all delay-150 duration-500 overflow-hidden h-screen bg-sky-100`}
        >
          <aside className="p-4">
            ...
            <nav>
              <ul className="flex flex-col pt-4 overflow-hidden">
                <li className="transition duration-500 hover:bg-sky-200 w-full h-full">
                  <Link to="/create" className="flex items-center h-8 px-2 py-6">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
